...
[![Codecov test coverage](https://codecov.io/gh/berthetclement/shiny_golem/graph/badge.svg)](https://app.codecov.io/gh/berthetclement/shiny_golem)
...
The goal of {testGolem} is to test workflow development with github actions.

## Installation

You can install the development version of testGolem from [GitHub](https://github.com/) with:
...
Currently, application is deployed on Posit server. You can access it [here](https://devappcbe.shinyapps.io/testGolem/)
